...
export function App() {
  return (
    <>
      <header className="w-full flex flex-row items-center justify-between bg-gradient-to-br from-[#313d46] to-[#597999] p-5 md:p-10 h-28 md:h-44">
      ...
      <nav className="w-fit flex flex-row items-center bg-black/70 rounded-br-3xl">
        <a
          ...
          className="flex items-center justify-center text-center text-white text-lg md:text-xl font-thin w-20 h-10 md:h-16 md:w-48 hover:bg-black/80 hover:font-extralight hover:shadow-xl transition-all"
        >
          <p>Portfolio</p>
        </a>
        <a
          href="https://music.ethanfranks.com"
          className="flex items-center justify-center text-center text-white text-lg md:text-xl font-thin w-20 h-10 md:h-16 md:w-48 hover:bg-black/80 hover:font-extralight hover:shadow-xl transition-all rounded-br-3xl"
        >
          <p>Music</p>
        </a>
      </nav>
